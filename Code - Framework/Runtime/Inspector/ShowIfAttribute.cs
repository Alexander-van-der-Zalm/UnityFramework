...
public class ShowIfAttribute : PropertyAttribute
{
    ...
    /// <summary>
    ///    DontDraw             -- Hide when false - normal when true
    ///    DontDrawShowReadOnly -- Hide when false - readonly when true
    ///    ReadOnly             -- Readonly when false - normal when true
    /// </summary>
    public enum DisablingType
    {
        DontDraw = 1, // Hide when false - normal when true
        DontDrawShowReadOnly = 2, // Hide when false - readonly when true
        ReadOnly = 3, // Readonly when false - normal when true
